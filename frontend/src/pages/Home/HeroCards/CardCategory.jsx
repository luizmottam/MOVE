const CardCategory = ({ id, title, description, backgroundImg }) => {
  return (
    <div className="flex flex-col items-center bg-white rounded-4xl shadow-2xl h-full hover:scale-104 hover:shadow-3xl transition-all duration-500 cursor-pointer">
